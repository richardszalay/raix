package raix.reactive.tests.operators.creation
{
	...
	public class URLLoaderFixture
	{
		...
		public function loads_text_data() : void
		{
			...
			Observable.urlLoader(new URLRequest("raix/reactive/tests/operators/creation/test.xml"))
				.delay(50)
				.subscribe(
		...
		public function passes_error_to_onerror() : void
		{
			...
			Observable.urlLoader(new URLRequest("raix/reactive/tests/operators/creation/does_not_exist.xml"))
				.delay(50)
